...
Manuals, spec sheets, links, warranties, receipts. One file per reference, or a short
index entry pointing at an artifact in `resource_intake/`.

Keep the original artifact (PDF/photo) in `resource_intake/` (or here); the `.md`
